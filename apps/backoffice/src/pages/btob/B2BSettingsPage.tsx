        ...
        <label className="flex items-center justify-between gap-2 rounded-md border border-border-subtle bg-bg-base px-3">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              min={0}
              max={365}
              className={`h-9 w-20 rounded-md bg-transparent px-2 text-right font-data tabular-nums text-sm text-text-primary ${FOCUS_RING}`}
          ...
          {buckets.map((b) => (
            <li key={b.id} className="grid grid-cols-1 items-center gap-2 rounded-md border border-border-subtle bg-bg-base p-2 sm:grid-cols-[1fr_auto_auto_auto_auto]">
              <input
                ...
                className={`h-9 rounded-md bg-transparent px-2 text-sm text-text-primary ${FOCUS_RING}`}
              />
              <input
                type="number"
                value={b.min}
                ...
                className={`h-9 w-20 rounded-md bg-bg-input px-2 text-right font-data tabular-nums text-sm text-text-primary ${FOCUS_RING}`}
              />
              ...
              <input
                ...
                className={`h-9 w-20 rounded-md bg-bg-input px-2 text-right font-data tabular-nums text-sm text-text-primary ${FOCUS_RING} placeholder:text-text-muted`}
              />
              <button
                type="button"
