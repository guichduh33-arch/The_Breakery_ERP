...
// in a single flat form. Each "Save" calls set_setting_v9 per dirty key so the
...
export default function SettingsGeneralPage() {
  ...
  // converting any price, and the server (set_setting_v9) refuses it while
  ...
  async function performSave() {
    ...
    try {
      ...
      // set_setting_v9 (Lot 6b) refuses the tax-mode switch while open orders
