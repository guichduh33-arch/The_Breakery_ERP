...
// record_batch_production_v7. Any failure (insufficient stock on any item,
...
export default function BatchProductionPage(): JSX.Element {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-[23px] font-semibold leading-tight tracking-[-0.015em] text-text-primary">Batch production</h1>
