...
// validation open < close, save = les 7 jours explicites via set_setting_v10.
...
describe('SettingsBusinessHoursPage', () => {
  ...
  it('saving writes all 7 explicit days through set_setting_v10', async () => {
    rpcCalls.length = 0;
    render(wrap(<SettingsBusinessHoursPage />));
    ...
    await waitFor(() =>
      expect(rpcCalls.some((c) => c.fn === 'set_setting_v10')).toBe(true));
