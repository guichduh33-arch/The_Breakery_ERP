    ...
    <Dialog open onOpenChange={(o) => { if (!o) onClose(); }}>
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-3">
          <div>
            <label htmlFor="del-reason" className="font-data font-semibold block text-xs uppercase tracking-wider text-text-secondary mb-1">
              Reason
            </label>
            <input
              id="del-reason"
        ...
        <DialogFooter>
          ...
          <Button
            ...
            // d'un aplat rouge est un TOKEN, qui suit le thème.
            className="bg-danger hover:bg-danger-hover text-danger-fg"
          >
