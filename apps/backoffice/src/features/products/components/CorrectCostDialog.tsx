        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 text-sm font-mono bg-bg-base border border-border-strong rounded focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold placeholder:text-text-muted"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2 text-sm bg-bg-base border border-border-strong rounded resize-none focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold placeholder:text-text-muted"
            />
          </div>
