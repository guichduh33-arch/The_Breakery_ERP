...
import { X, BarChart3, Activity, Package, Wallet, Ban, Layers, type LucideIcon } from 'lucide-react';
import { Button, cn } from '@breakery/ui';
import { useReportsPeriod, type ReportsPeriod } from '../hooks/useReportsPeriod';

type POSReportsTab = 'overview' | 'payments' | 'voids' | 'sessions' | 'products' | 'activity';
