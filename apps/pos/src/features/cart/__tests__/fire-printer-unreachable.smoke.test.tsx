...
// fire_counter_order_v5 BEFORE printing.
...
//   • fire_counter_order_v5 called first, then hold_fired_order_v1.
...
// Session 43 / P0-3 — the fire now persists via fire_counter_order_v5 first.
