...
describe('SendToKitchenButton — unrouted product warning (LOT 3)', () => {
  ...
  it('warns that 1 line is not routed to any kitchen station', async () => {
    ...
    // Bloc 2: hold_fired_order_v2 is called after fire, so 2 RPC calls total.
    ...
    expect(rpcMock).toHaveBeenNthCalledWith(2, 'hold_fired_order_v2', expect.objectContaining({ p_order_id: 'order-db-1' }));
  });
});
