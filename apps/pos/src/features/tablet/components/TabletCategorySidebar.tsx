...
const TILE_BASE = cn(
  'relative w-full min-h-16 max-[1099px]:w-auto max-[1099px]:min-w-[100px] max-[1099px]:min-h-12 max-[1099px]:shrink-0 max-[1099px]:flex-row max-[1099px]:px-3 max-[1099px]:py-1 px-2 py-3 flex flex-col items-center justify-center gap-1.5 rounded-md border',
