  ...
  return (
    <div className="flex-1 min-w-0 min-h-0 flex flex-col overflow-hidden">
      <div className="shrink-0 px-3 py-2 flex flex-wrap items-center justify-between gap-2 border-b border-border-subtle">
        ...
        <h2 className="min-w-0 break-words font-sans font-semibold text-base text-text-primary capitalize">{title}</h2>
      ...
      <div className="flex-1 min-h-0 overflow-y-auto p-2 sm:p-3">
        {isError ? (
          ...
          <div className="grid grid-cols-[repeat(auto-fill,minmax(140px,1fr))] gap-3" aria-busy="true" aria-label="Loading products">
