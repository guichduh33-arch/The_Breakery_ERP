...
export function TabletOrderPage({
  ...
  const toolbar = (
    <div
      className="shrink-0 px-2 py-1 grid grid-cols-[minmax(0,1fr)_minmax(0,1.4fr)] sm:flex sm:flex-wrap items-center gap-2 border-b border-border-subtle bg-bg-elevated"
    ...
    >
      <Button
        ...
        className={
          tableMissing
            ? 'h-12 min-h-12 min-w-0 gap-1 px-2 text-sm border-amber-warn text-amber-warn'
            : 'h-12 min-h-12 min-w-0 gap-1 px-2 text-sm'
        }
