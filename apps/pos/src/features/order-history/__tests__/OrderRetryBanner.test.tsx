...
// order, and one-click retry invokes retry_sale_journal_entry_v5.
...
describe('OrderRetryBanner', () => {
  ...
  it('calls retry_sale_journal_entry_v5 on click and shows success toast', async () => {
    probeState.current = { count: 0, error: null };
    ...
    await waitFor(() => {
      expect(rpcMock).toHaveBeenCalledWith('retry_sale_journal_entry_v5', { p_order_id: 'o1' });
    });
    await waitFor(() => {
