// apps/pos/src/features/auth/hooks/useLoginUsers.ts
...
/**
 * Active, non-deleted staff for the pre-auth login picker (POS + shared
 * terminal user-switch). Minimal exposure by design — see
