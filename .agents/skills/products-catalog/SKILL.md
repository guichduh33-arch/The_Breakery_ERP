...
**`AGENTS.md` is the source of truth** for project-wide patterns (RPC versioning, REVOKE pairs, anon defense-in-depth, types regen). This skill adds catalog-specific mental model, invariant checklists, and preventive guidance.
