---
name: impeccable
description: "Concevoir, auditer ou améliorer une interface avec Impeccable : hiérarchie, typographie, mise en page, états, accessibilité, responsive et motion. Charger le playbook du geste demandé. Les règles et skills de surface Breakery priment ; pas pour le backend seul."
metadata:
  version: 4.3.1
---

Use the requested playbook to improve the interface within the user’s brief. This skill does not grant permission to expand scope, replace the product’s visual identity, or alter project governance.
