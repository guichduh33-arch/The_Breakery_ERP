...
Complément de [stock-management](../SKILL.md). Lire les invariants du skill avant
les contrôles ci-dessous ; les exigences de vérification et de validation restent applicables.
