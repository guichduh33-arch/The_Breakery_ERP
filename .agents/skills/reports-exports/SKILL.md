...
**`AGENTS.md` est la source de vérité** pour les patterns globaux (REVOKE pair, idempotency 2-flavors, PIN header, RPC versioning). Ce skill ajoute la surface map reports/exports, les checklists métier, et les pointeurs vers les fichiers réels.
