...
**`AGENTS.md` est la source de vérité** for project-wide critical patterns. This skill adds
security-specific mental models, exact SQL blocks (verified from migrations), audit checklists,
and preventive guidance that AGENTS.md doesn't carry at this level of detail.
...
gravé dans AGENTS.md ; deux skills se contredisaient) :
