...
// Session 12 — T16: concurrency / row-lock serialization for adjust_stock_v2.
//
...
describe.skipIf(!process.env.SUPABASE_SERVICE_ROLE_KEY)('inventory concurrency — adjust_stock_v2 row-lock serialization', () => {
