...
BEGIN
  r := complete_order_with_payment_v20(
    ...
    p_payment := '{"method":"cash","amount":40000,"cash_received":40000,"change_given":0}'::jsonb);
  PERFORM void_order_rpc_v7((r->>'order_id')::uuid, 'modifier void test', '00000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000002');
END $$;
...
BEGIN
  ...
  PERFORM void_order_rpc_v7((r->>'order_id')::uuid, 'display modifier void', '00000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000002');
END $$;
