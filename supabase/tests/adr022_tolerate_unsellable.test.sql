...
--
-- Les deux portes qui portent le drapeau sont couvertes (`fire_counter_order_v6`,
-- `create_tablet_order_v6`). `add_order_item_v5` n'en a pas : elle n'est ni
...
-- ===========================================================================
-- PORTE COMPTOIR — fire_counter_order_v6
-- ===========================================================================
...
-- ===========================================================================
-- PORTE SALLE — create_tablet_order_v6
-- ===========================================================================
