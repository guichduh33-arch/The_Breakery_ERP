...
-- ADR-013 Lot 2 D1 — void_order_rpc_v10 refuse le void si un refund partiel
...
BEGIN
  ...
  BEGIN
    PERFORM void_order_rpc_v10(v_order_id, 'D1 void after partial refund', v_manager_prof, v_cashier_auth, NULL);
...
BEGIN
  ...
  v_res := void_order_rpc_v10(v_order_id, 'D1 clean void', v_manager_prof, v_cashier_auth, NULL);
