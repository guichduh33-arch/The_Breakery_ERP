...
SELECT ok(NOT has_function_privilege('anon','complete_order_with_payment_v20(uuid, order_type, jsonb, jsonb, uuid, uuid, integer, text, numeric, text, numeric, text, uuid, jsonb, jsonb, uuid)','EXECUTE'), 'T6 anon EXECUTE revoked on v17');
