...
-- ADR-013 Lot 2 D9 — pay_existing_order_v14 : la remise money-path exige un nonce
...
-- T1 : discount > 0 sans authorizer → P0001
SELECT throws_ok(
  ...
  'P0001', NULL, 'T1 discount sans authorizer → P0001');
