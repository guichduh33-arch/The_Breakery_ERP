...
--   T1a : close_shift_v4(uuid,numeric,text,uuid,uuid,text) exists
...
-- ===========================================================================
SELECT has_function('public', 'close_shift_v4', ARRAY['uuid', 'numeric', 'text', 'uuid', 'uuid', 'text'],
  'T1a: close_shift_v4(uuid,numeric,text,uuid,uuid,text) exists');
SELECT hasnt_function('public', 'close_shift_v3', ARRAY['uuid', 'numeric', 'text', 'uuid'],
  'T1b: close_shift_v3 dropped (bump v3 -> v4)');
...
-- ===========================================================================
SELECT throws_ok(
  $$SELECT close_shift_v4('60c50001-0000-0000-0000-000000000001'::uuid, 10100000, NULL, NULL)$$,
  'P0001', NULL,
...
-- ===========================================================================
SELECT lives_ok(
  format($$SELECT close_shift_v4('60c50001-0000-0000-0000-000000000001'::uuid, 10100000, %L, NULL)$$,
...
-- ===========================================================================
SELECT lives_ok(
  $$SELECT close_shift_v4('60c50001-0000-0000-0000-000000000002'::uuid, 300000, NULL, NULL)$$,
  'T4: zero-variance close, no note -> succeeds (note not required)'
);
...
BEGIN
  BEGIN
    v_res := close_shift_v4('60c50001-0000-0000-0000-000000000001'::uuid, 10100000, NULL, NULL);
