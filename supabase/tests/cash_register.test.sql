...
-- T_SHIFT_03: record_cash_movement_v2 + close_shift_v4 functions exist
...
SELECT has_function('public', 'close_shift_v4',
  ARRAY['uuid','numeric','text','uuid','uuid','text'],
  'T_SHIFT_03b: close_shift_v4');
