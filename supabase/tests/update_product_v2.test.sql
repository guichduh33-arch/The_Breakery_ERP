-- supabase/tests/update_product_v4.test.sql
...
SELECT throws_ok(
  format($q$SELECT update_product_v4(%L::UUID, '{"name":"nope"}'::JSONB)$q$,
         current_setting('breakery.s27_product_id')),
  '42501',
  'permission_denied',
  'T2 CASHIER cannot call update_product_v4 (42501 permission_denied)'
);
