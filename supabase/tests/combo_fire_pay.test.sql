...
-- Session 47 / fire-path extension — fire_counter_order_v4 + pay_existing_order_v13
...
-- Hardening checks.
SELECT ok(NOT has_function_privilege('anon','pay_existing_order_v13(uuid, jsonb, uuid, integer, uuid, numeric, text, numeric, text, uuid, jsonb, jsonb, boolean)','EXECUTE'),
  'T6 anon EXECUTE revoked on pay_existing_order_v13');
