...
-- ── Task 2: record_cash_movement_v1 ───────────────────────────────────────────
DO $$
DECLARE v_je uuid;
BEGIN
...
SELECT throws_ok(
  $q$ SELECT record_cash_movement_v1('bank_deposit',-5,CURRENT_DATE,'x',
        '22222222-2222-2222-2222-222222222222',NULL) $q$,
  'P0001', NULL, 'non-positive amount rejected');
SELECT throws_ok(
  $q$ SELECT record_cash_movement_v1('teleport',5,CURRENT_DATE,'x',
        '33333333-3333-3333-3333-333333333333',NULL) $q$,
  'P0001', NULL, 'unknown movement type rejected');
SELECT throws_ok(
  $q$ SELECT record_cash_movement_v1('adjustment_gain',5,CURRENT_DATE,'count over',
