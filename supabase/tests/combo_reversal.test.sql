...
BEGIN
  ...
  PERFORM void_order_rpc_v2((r->>'order_id')::uuid, 'combo void test', '00000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000002');
END $$;
DO $$
...
BEGIN
  ...
  PERFORM refund_order_rpc_v3((r->>'order_id')::uuid,
