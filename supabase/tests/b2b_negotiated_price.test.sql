...
-- and that create_b2b_order bills the resolved price, ignoring the client unit_price.
...
-- 4. create_b2b_order ignores the client unit_price (send 999999, expect billed at resolved retail 5000)
DO $mk$
DECLARE v_res jsonb;
BEGIN
