...
-- S53 P1.4 — create_b2b_order_v6 is display-aware: a display item (is_display_item) sold via a
...
DO $d$ DECLARE v jsonb; BEGIN
  v := create_b2b_order_v6('ccc40001-0000-0000-0000-000000000001',
...
INSERT INTO _cap SELECT ok((SELECT pass FROM _r WHERE name='order'), 'B2B display order succeeds via create_b2b_order_v6');
