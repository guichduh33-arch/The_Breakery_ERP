...
--   T10 : create_b2b_order_v2 over credit limit → P0011 (TOCTOU gate fires)
...
-- ===========================================================================
-- T10 — create_b2b_order_v2 over credit limit (TOCTOU gate fires)
-- ===========================================================================
DO $t10_setup$
DECLARE v_admin UUID := current_setting('breakery.admin_uid')::uuid;
BEGIN
...
SELECT throws_ok(
  ...
  'P0011', NULL,
  'T10: create_b2b_order_v2 over credit limit raises P0011 (re-check after lock)');
