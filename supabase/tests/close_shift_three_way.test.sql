...
-- S67 (12 D2.2/D2.3) — close_shift_v8 : comptage 3 volets + grille coupures.
...
SELECT lives_ok(
  $$SELECT close_shift_v8('67c50001-0000-0000-0000-000000000001'::uuid, 500000)$$,
...
DECLARE v_res JSONB;
BEGIN
  v_res := close_shift_v8('67c50001-0000-0000-0000-000000000002'::uuid, 500000,
...
SELECT throws_ok(
  $$SELECT close_shift_v8('67c50001-0000-0000-0000-000000000003'::uuid, 500000,
...
SELECT throws_ok(
  $$SELECT close_shift_v8('67c50001-0000-0000-0000-000000000004'::uuid, 352000)$$,
...
BEGIN
  BEGIN
    v_res := close_shift_v8('67c50001-0000-0000-0000-000000000004'::uuid, 352000);
