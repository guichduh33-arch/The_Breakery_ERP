...
-- S66 (12 D2.1) — close_shift_v6 : approbation manager (approbateur désigné +
...
-- ===========================================================================
SELECT lives_ok(
  $$SELECT close_shift_v6('66c50001-0000-0000-0000-000000000002'::uuid, 10100000, 'over from event float', NULL)$$,
...
-- ===========================================================================
SELECT throws_ok(
  $$SELECT close_shift_v6('66c50001-0000-0000-0000-000000000001'::uuid, 800000, 'large overage, event cash', NULL)$$,
...
SELECT throws_ok(
  format(
    $$SELECT close_shift_v6('66c50001-0000-0000-0000-000000000001'::uuid, 800000, 'large overage, event cash', NULL, %L::uuid, '654321')$$,
...
SELECT throws_ok(
  format(
    $$SELECT close_shift_v6('66c50001-0000-0000-0000-000000000001'::uuid, 800000, 'large overage, event cash', NULL, %L::uuid, '12ab56')$$,
...
SELECT throws_ok(
  format(
    $$SELECT close_shift_v6('66c50001-0000-0000-0000-000000000001'::uuid, 800000, 'large overage, event cash', NULL, %L::uuid, '111111')$$,
    current_setting('shift66.appr_prof')
  ),
  'P0003', 'invalid_pin',
...
BEGIN
  BEGIN
    v_res := close_shift_v6('66c50001-0000-0000-0000-000000000001'::uuid, 800000, NULL, NULL);
