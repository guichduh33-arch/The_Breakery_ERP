...
-- fire_counter_order_v5 / pay_existing_order_v16 avec les clés d'idempotence
...
SELECT is(
  has_function_privilege('anon',
    'public.pay_existing_order_v16(uuid,jsonb,uuid,integer,uuid,numeric,text,numeric,text,uuid,uuid,jsonb,jsonb,boolean)',
    'EXECUTE'),
  false, 'T9: anon revoked on pay_existing_order_v16');
