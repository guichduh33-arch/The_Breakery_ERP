...
-- fire_counter_order_v9 / pay_existing_order_v20 avec les clés d'idempotence
...
SELECT is(
  has_function_privilege('anon',
    ...
    'EXECUTE'),
  false, 'T9: anon revoked on pay_existing_order_v20');
...
DECLARE v_ord UUID;
BEGIN
  v_ord := (SELECT (fire_counter_order_v9(
