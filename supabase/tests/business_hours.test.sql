...
--   set_setting_v10 'business_hours' (validation forme + bornes),
--   get_settings_by_category_v8('business') (readback),
...
DO $$ DECLARE v JSONB; BEGIN
  PERFORM set_setting_v10('business_hours',
    '{"mon": {"open": "07:00", "close": "22:00"}, "tue": null}'::jsonb, 'business');
  v := get_settings_by_category_v8('business')->'settings'->'business_hours';
...
DO $$ BEGIN
  PERFORM set_setting_v10('business_hours', '{"monday": {"open": "07:00", "close": "22:00"}}'::jsonb, 'business');
...
DO $$ BEGIN
  PERFORM set_setting_v10('business_hours', '{"mon": {"open": "7h00", "close": "22:00"}}'::jsonb, 'business');
...
DO $$ BEGIN
  PERFORM set_setting_v10('business_hours', '{"mon": {"open": "22:00", "close": "07:00"}}'::jsonb, 'business');
...
DO $$ DECLARE v_ok BOOLEAN := true; BEGIN
  BEGIN
    PERFORM set_setting_v10('business_hours', '{"mon": 5}'::jsonb, 'business');
    v_ok := false;
  EXCEPTION WHEN SQLSTATE '22023' THEN NULL; END;
  BEGIN
    PERFORM set_setting_v10('business_hours', '{"mon": {"open": "07:00"}}'::jsonb, 'business');
    v_ok := false;
  EXCEPTION WHEN SQLSTATE '22023' THEN NULL; END;
