...
-- Bloc 2 (Task 2) : create_b2b_order attribue l'invoice_number à la création.
BEGIN;
SELECT plan(6);

SELECT has_function('public', 'create_b2b_order_v7',
  ARRAY['uuid','jsonb','text','date','uuid'], 'create_b2b_order existe');
...
BEGIN
  v1 := create_b2b_order_v7('ccc68001-0000-0000-0000-000000000001',
  ...
  v2 := create_b2b_order_v7('ccc68001-0000-0000-0000-000000000001',
...
DO $d$ DECLARE v jsonb; BEGIN
  v := create_b2b_order_v7('ccc68009-0000-0000-0000-000000000009',
