...
-- (pg_get_functiondef, DEV-S57-02 — vérifié identique à 20260710000020) ;
-- seuls ajouts : WHEN 'payments' (get) et WHEN 'enabled_payment_methods' (set).
...
-- ── get_settings_by_category_v1 : ajouter la catégorie ''payments'' ──────────
...
-- ── set_setting_v1 : ajouter la clé ''enabled_payment_methods'' ──────────────
