...
-- order_status enum (S33): draft, paid, voided, pending_payment, completed, b2b_pending
-- refunds.total column confirmed (DEV-S32-1.A-03, not .amount).
-- orders.voided_at column confirmed (20260512000003).
