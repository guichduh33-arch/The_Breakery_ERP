-- 20260710000120_settings_rpcs_shift_variance_pin_thresholds.sql
-- S66 (fiche 12 D2.1) — expose les 2 nouveaux seuils PIN de clôture
-- (business_config.shift_variance_pin_threshold_abs/pct, _118) dans le couple
-- settings du BO :
--   - get_settings_by_category_v1 : branche 'pos' +2 clés ;
--   - set_setting_v1 : +2 WHEN (validation number >= 0, audit old/new hérité),
--     miroir exact des cases shift_variance_threshold_* existantes.
-- In-place (signatures inchangées, pas de bump) — corps repris DU LIVE via
-- pg_get_functiondef le 2026-07-07 (DEV-S57-02 : S64 a modifié ces corps
-- depuis leurs fichiers d'origine _190/_003 ; ne jamais repartir des fichiers).
