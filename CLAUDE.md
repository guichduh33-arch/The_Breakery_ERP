...
- **In flight:** rien — **P2 : SOLDÉ** (P2.1→P2.6, S56+S57) ; P1 soldée (S51→S55). **Prochaine session (S58)** : P3 de l'audit (**FIFO/lots/péremption — spec dédiée requise avant code**, décision `allow_negative_stock`, cron alertes stock) et/ou reliquat Spec B Phase 2 (Sales + Expenses bulk import) — cf. `docs/workplan/audits/2026-06-27-audit-integral-par-module.md` §7 P3 + backlog-by-module. Spec-B-1 design `docs/superpowers/specs/2026-06-26-pos-spec-b1-dispatch-routing-design.md`.
