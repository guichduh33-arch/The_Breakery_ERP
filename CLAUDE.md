...
> Read this **before** opening code on Session 19 work.

- **Current session:** Session 19 — TBD (next session opens with backlog triage post-S18 merge).
...
- **Session 13 follow-ups (deferred Session 19+):** Playwright CI job (D-W6-6C-05), `pg_net`-based birthday cron (D-W6-6B-02), Cash Flow Investing/Financing sections (D-W6-6A-2), `mv_pl_monthly` branched reuse (D-W6-6A-1), staging-deploy.yml secrets (D-W6-CICD-01).
...
- **Backlogs:** `docs/workplan/backlog-by-module/01-…25-….md` — 25 modules, ~280 tasks total. Session 19 source : TBD (open with backlog triage post-S18 merge).
