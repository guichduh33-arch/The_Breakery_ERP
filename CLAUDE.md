...
- **Status:** Wave 0 (Prereqs, no code) ✓, Wave 1 (Foundations: Accounting / Security / Inventory F1 / Design tokens) ✓ — 27 migrations authored on cloud, ~100 tests written. Wave 2 (Reports + Production + Promotions + Inventory tightening) next.
