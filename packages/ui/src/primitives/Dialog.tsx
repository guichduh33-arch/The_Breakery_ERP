...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 ring-offset-bg-base transition-opacity hover:opacity-100 focus:outline focus:outline-2 focus:outline-gold focus:outline-offset-2 disabled:pointer-events-none data-[state=open]:bg-bg-overlay data-[state=open]:text-text-muted">
        <X className="h-4 w-4" />
