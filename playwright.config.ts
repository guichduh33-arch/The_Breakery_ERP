...
export default defineConfig({
  ...
  projects: [
    {
      name: 'pos',
      testMatch: /(complete-order|pos-login-order|pos-responsive|s43-pos-audit-fixes|s44-money-path)\.spec\.ts$/,
      use: {
    ...
    {
      name: 'backoffice',
      testMatch: /(opname-finalize|po-receive|bo-admin-pin-reset|kiosk-display-realtime|s39-bo-completion|s40-reports|s41-catalog-import|stock-inventory-pages|kitchen-tablet)\.spec\.ts$/,
      use: {
        ...devices['Desktop Chrome'],
