...
**Spec:** [`../specs/2026-05-17-session-19-spec.md`](../../specs/archive/2026-05-17-session-19-spec.md)
...
*INDEX écrit 2026-05-17 sur `swarm/session-19` par lead. Spec : [`../specs/2026-05-17-session-19-spec.md`](../../specs/archive/2026-05-17-session-19-spec.md). Brainstorm + design via `superpowers:brainstorming` (5 clarifying Qs + 4 design-section approvals). Plan via `superpowers:writing-plans`.*
