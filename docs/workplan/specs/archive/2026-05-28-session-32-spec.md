> 🗄️ **ARCHIVED / SUPERSEDED (banner added 2026-06-04).** This draft numbered the POS-audit work as **Session 32** before the **Reports Vague C** track took the S32 slot (merged PR #40). The "POS Service Polish" scope was re-numbered to **Session 35** (`2026-05-29-session-35-spec.md`, merged PR #62). Never executed under this number (no INDEX). Kept verbatim for history — do not act on the session number.
