> 🗄️ **ARCHIVED / SUPERSEDED (banner added 2026-06-04).** This draft numbered the POS-audit work as **Session 31** before the **Reports Drill-Down** track took the S31 slot (merged PR #39). The POS-audit findings were re-scoped and re-numbered into the **2026-05-29 session-33/34/35** specs & plans. Never executed under this number (no INDEX). Kept verbatim for history — do not act on the session number.
