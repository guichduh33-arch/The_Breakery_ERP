...
> **Module de référence associé** : [`../../reference/04-modules/13-promotions-discounts.md`](../../../reference/04-modules/13-promotions-discounts.md) (contexte session 8 promotions / perf-debt).
