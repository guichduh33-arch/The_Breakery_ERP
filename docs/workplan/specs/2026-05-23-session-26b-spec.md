...
Cette session ferme la moitié `S26b` du split documenté dans [INDEX S26 §8](../plans/2026-05-20-session-26-INDEX.md). Les pages PB1 / AR Aging / Bank Reconciliation / CALK + Wave 4 tests + Wave 5 docs rebase restent pour **S26c**.
