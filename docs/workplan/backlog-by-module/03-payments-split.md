...
### TASK-03-001 — Idempotence split en cas de double-clic [P1] [TODO]
...
### TASK-03-002 — Retry logic `complete_order_with_payments` (network glitch) [P1] [TODO]
...
### TASK-03-005 — QRIS Indonésien natif (GoPay/OVO/DANA/ShopeePay) [P2] [TODO]
