...
- **Prix négociés par client** : table de tarifs (client×produit ou client×remise), application **côté serveur** dans `create_b2b_order_v4` (le prix client devient indicatif, pattern S51 « prix canonique serveur »').
