...
| 09 | [Clients pros (B2B)](09-b2b-wholesale.md) | Opérationnel | 6 | 0 | 1 | ~~ni facture PDF~~ facture PDF (S68) ; **prix négocié client livré (S69)** ; ~~reste surclamé : cycle livraison~~ → **hors périmètre** | ~~Chantier cycle de livraison~~ **ANNULÉ (2026-07-10 : pas de livraisons B2B)** |
...
**Décision propriétaire — 2026-07-10 : pas de livraisons B2B.** The Breakery ne gère pas de cycle de livraison B2B (préparation → livraison partielle → livrée). Conséquences : le chantier **cycle de livraison B2B (fiche 09, D3.1)** est **ANNULÉ** (le stock reste déduit à la création, modèle actuel conservé) ; l'item dépendant **avoirs officiels B2B (09-B2.4)** tombe aussi ; côté doc v1.3, retirer la revendication « cycle confirmée→préparation→prête→livrée + livraisons partielles » (module 09-B1.3) plutôt que la reformuler « À venir ». Le fait générateur de la JE AR B2B (module 10) reste donc « à la création » — non impacté.
