...
> Date : 2026-07-09 · Session : S71 · Statut : **EN COURS**
...
- [ ] **P2-3** — hrefs vivants cassés : `plans/2026-07-08-session-69-INDEX.md` (préfixe `../../superpowers/`), `specs/2026-06-27-session-50-spec.md` (lien audit inexistant), `audits/2026-06-27-project-state-and-gaps.md` (→ curation daté du 28).
- [ ] **P2-4** — Archiver `docs/audit/2026-05-28-pos-audit.md` + `2026-06-12-stock-management-audit.md` → `docs/audit/archive/`.
- [ ] **P2-5** — `docs/DESIGN_POS_AND_BACKOFFICE.md` : repointer `docs/Design/` → `_archive/design-screenshots-pre-code/`, marquer `_bmad`/`breakery-platform` absents.
- [ ] **P2-6** — `docs/V2_V3_GLOSSARY.md` : bannière de péremption (versions RPC → CLAUDE.md) + fix lien backlog.
- [ ] **P2-7** — `docs/reference/05-integrations/06-print-server.md` : marquer la moitié V3 (station-routing S34, print-bridge) à promouvoir hors référence V2 (note, pas d'extraction lourde).

---

## Garde-fou anti-dérive

- [ ] Coller la checklist « FIN DE SESSION » (audit §7.2) dans `CLAUDE.md` (section closeout / conventions).
