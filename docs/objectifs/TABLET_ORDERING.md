...
> **Statut V2/V3** : décrit la vision business cible. **V2 jamais déployée**. Implémentation V3 = DONE + amélioré (famille `create_tablet_order` + table `idempotency_keys`, `useCreateTabletOrder` + client_uuid lifecycle, `useTabletOffline`, PIN auth, ACK hub). Voir [`../V2_V3_GLOSSARY.md`](../V2_V3_GLOSSARY.md).
>
