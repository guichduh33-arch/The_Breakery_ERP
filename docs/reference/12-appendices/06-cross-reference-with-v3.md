...
| Documentation | `docs/reference/` (cette doc unifiée — 4 parties par module) + `docs/workplan/` (plans, specs, backlog) | `_bmad/output/planning-artifacts/` (architecture, epics, PRD) |
