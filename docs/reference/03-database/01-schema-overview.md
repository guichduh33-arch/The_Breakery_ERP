...
See module spec [../04-modules/01-auth-permissions.md](../04-modules/01-auth-permissions.md). Flow: [08-flows-end-to-end](../08-flows-end-to-end/).
...
See [06-rls-policies.md](./06-rls-policies.md) for the current RLS state (post-2026-02-22 audit consolidated).
...
- Security & RLS report: [../07-security/](../07-security/) and [06-rls-policies.md](./06-rls-policies.md) *(post-2026-02-22 audit, current state)*
