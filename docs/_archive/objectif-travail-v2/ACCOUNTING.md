...
> 🗄️ **ARCHIVED / SUPERSEDED (2026-06-04).** This legacy V2 "Objectif métier" brief was folded verbatim into **Partie I — Vue fonctionnelle** of the canonical reference module [`reference/04-modules/10-accounting-double-entry.md`](../../reference/04-modules/10-accounting-double-entry.md) (2026-05-13). The reference is the source of truth; this file is kept for history only.
