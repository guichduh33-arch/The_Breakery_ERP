...
> **Périmètre fonctionnel** : ce document décrit **ce que le module sert à faire au quotidien** pour The Breakery, sans rentrer dans la mécanique technique (hooks, RPC, tables, etc.).
