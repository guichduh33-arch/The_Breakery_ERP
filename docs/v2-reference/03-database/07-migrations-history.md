...
- `docs/v2/RLS_AUDIT_REPORT.md` — narrative of the 11-migration RLS hardening (2026-02-22)
- `docs/v2-reference/03-database/06-rls-policies.md` — current RLS state
- `docs/v2-reference/03-database/05-views-and-matviews.md` — view churn chronicled by migration
- `docs/v2-reference/03-database/08-seed-data.md` — initial data inserted by `014_seed_data.sql` and successors
