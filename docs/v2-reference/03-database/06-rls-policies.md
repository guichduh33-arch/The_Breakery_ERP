...
> **Source**: `docs/v2/RLS_AUDIT_REPORT.md` (2026-02-22, post-correction state) + 52 migrations matching `CREATE POLICY` (latest: `20260413100100_create_ghost_tables_with_rls.sql`)
...
See `docs/v2/modules/01-auth-users.md` for Edge Function auth flow.
...
11 corrective migrations applied (all dated 2026-02-22). Full chronology in `docs/v2/RLS_AUDIT_REPORT.md` §Migrations Appliquees.
...
- `docs/v2/RLS_AUDIT_REPORT.md` — full pre/post audit narrative (2026-02-22)
