...
> **Source d'objectifs** : `docs/objectif travail/PURCHASING_AND_SUPPLIERS.md`
...
### 0.2 État cible V3 (cf. PURCHASING_AND_SUPPLIERS.md)
...
### 0.3 Hors scope V3 (limites assumées — cf. §15 PURCHASING_AND_SUPPLIERS.md)
...
**Fin du spec.** Décomposition en 10 sous-phases : `docs/superpowers/plans/2026-05-12-purchasing-complete-INDEX.md`.
