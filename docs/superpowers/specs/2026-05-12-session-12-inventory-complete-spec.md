...
> **Remplace** : `2026-05-11-session-12-inventory-mvp-spec.md` (MVP — couverture ~15% de l'objectif métier)
> **Source d'objectifs** : `docs/objectif travail/INVENTORY.md`
> **Cible** : Livrer le module Inventory **complet** tel que décrit dans INVENTORY.md — les 7 onglets (Stock, Incoming, Transfers, Wastage, Production, Opname, Movements) + Dashboard produit analytique + Panneau d'alertes + Sections / Locations + couplage comptable automatique. Exécution prévue en **8 sous-phases** ; cf. `2026-05-12-session-12-inventory-complete-INDEX.md`.
...
| **C19** | Pas de FEFO / batch | Conformément à INVENTORY.md §15 : pas de `stock_batches`, pas de tracking par DLC individuelle. Péremption gérée manuellement (waste). |
| **C20** | Pas de prévision ML | Suggestions = règles simples (vitesse récente vs stock courant). Pas de scikit-learn / prophet. Conforme INVENTORY.md §15. |
...
Cette session livre l'inventory complète conforme à INVENTORY.md. Les évolutions futures :
...
**Fin du spec.** Décomposition en 8 sous-phases : `docs/superpowers/plans/2026-05-12-session-12-inventory-complete-INDEX.md`.
