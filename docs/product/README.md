...
## Contenu attendu
- **`DESCRIPTION.md`** : la Description **v1.3** = le contenu de `The_Breakery_ERP_Description_v1.2.docx` (2026-07-03) corrigé par une checklist d'amendements (surclaims retirés, sous-ventes ajoutées, décision péremption/FIFO intégrée — cf. [ADR-004](../adr/004-pas-de-peremption-ni-fifo-stock.md)).
...
4. La vérification se fait contre les fiches `docs/objectifs/` (méthode réel-vs-demandé) et, pour tout fait, contre le code.
