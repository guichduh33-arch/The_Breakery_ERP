...
- Le typecheck et les tests pertinents passent ; distinguer tests exécutés, ignorés et absents. Un échec d'environnement exige un diagnostic, pas une exemption fondée sur une ancienne baseline (voir CLAUDE.md et `test-engineer`).
